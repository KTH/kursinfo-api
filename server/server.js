...
const { SellingInfo, ImageInfo, CourseWebLink, CourseInfo } = require('./controllers')
...
// all images name
apiRoute.register(paths.api.getUploadedImagesNames, SellingInfo.getUploadedImagesNames)
